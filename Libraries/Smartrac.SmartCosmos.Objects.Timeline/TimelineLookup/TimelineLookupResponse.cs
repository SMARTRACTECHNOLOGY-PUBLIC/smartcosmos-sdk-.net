...
{
    public class TimelineLookupsResponse : List<TimelineLookupResponse>, IHttpStatusCode
    {
        public HttpStatusCode HTTPStatusCode { get; set; }

        public TimelineLookupsResponse()
            : base()
        {
    ...
    public class TimelineLookupResponse : DefaultResponse
    {
        public TimelineLookupResponse()
            : base()
        {
            account = null;
