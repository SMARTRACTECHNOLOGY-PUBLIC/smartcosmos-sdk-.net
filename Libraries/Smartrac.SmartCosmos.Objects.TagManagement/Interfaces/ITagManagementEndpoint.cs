...
namespace Smartrac.SmartCosmos.Objects.TagManagement
{
    ...
    public interface ITagManagementEndpoint : IBaseEndpoint
    {
        /// <summary>
        ...
        TagActionResult Create(TagManagementRequest requestData, out TagManagementResponse responseData);
        ...
        /// <returns>TagManagementActionResult</returns>
        TagActionResult Lookup(Urn tagUrn, out TagDataResponse responseData, ViewType viewType = ViewType.Standard);
        ...
        /// <param name="responseData">Tag data</param>
        /// <returns>TagManagementActionResult</returns>
        TagActionResult Lookup(string tagName, out TagDataResponse responseData, ViewType viewType = ViewType.Standard);
        ...
        /// <param name="responseData">Tag data</param>
        /// <returns>TagManagementActionResult</returns>
        TagActionResult Lookup(EntityReferenceType entityReferenceType, Urn referenceUrn,
            out TagDataListResponse responseData, ViewType viewType = ViewType.Standard);
        ...
        /// <param name="responseData">Tag data</param>
        /// <returns>TagManagementActionResult</returns>
        TagActionResult Assign(EntityReferenceType entityReferenceType, Urn referenceUrn,
        ...
        TagActionResult Delete(Urn tagUrn);
    }
}
