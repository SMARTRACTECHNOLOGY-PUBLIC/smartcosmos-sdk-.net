...
{
    public class BaseTestCaseDataImportEndpoint : BaseProfilesTestCase<ITagDataContext, IDataImportEndpoint>
    {
        ...
        protected override IDataImportEndpoint CreateEndpoint()
        {
            return EndpointFactory.CreateDataImportEndpoint();
        }
    }
}