...
{
    public class BaseTestCasePlatformAvailabilityEndpoint : BaseProfilesTestCase<IBaseDataContext, IPlatformAvailabilityEndpoint>
    {
        protected override bool PrepareDataContext()
        {
